    ...
    var Master_Addons = {
                ...
                (function($) {
                    ...
                    Master_Addons.MA_Animated_Headlines.animateHeadline = function($headlines) {
                        ...
                        $headlines.each(function() {
                            ...
                            if (headline.hasClass('loading-bar')) {
                                ...
                                setTimeout(function() {
                                    headline.find('.ma-el-words-wrapper').addClass('is-loading')
                                }, barWaiting);
                            ...
                            //trigger animation
                            setTimeout(function() {
                                Master_Addons.MA_Animated_Headlines.hideWord(headline.find('.is-visible').eq(0))
                            }, duration);
                        });
                    }
                    ...
                    Master_Addons.MA_Animated_Headlines.hideWord = function($word) {
                        ...
                        if ($word.parents('.ma-el-animated-headline').hasClass('type')) {
                            ...
                            setTimeout(function() {
                                Master_Addons.MA_Animated_Headlines.showWord(nextWord, typeLettersDelay)
                            }, typeAnimationDelay);
                            ...
                            $word.parents('.ma-el-words-wrapper').animate({
                                width: '2px'
                            ...
                            Master_Addons.MA_Animated_Headlines.switchWord($word, nextWord);
                            setTimeout(function() {
                                Master_Addons.MA_Animated_Headlines.hideWord(nextWord)
                            }, barAnimationDelay);
                            setTimeout(function() {
                                $word.parents('.ma-el-words-wrapper').addClass('is-loading')
                            }, barWaiting);
                    ...
                    Master_Addons.MA_Animated_Headlines.showWord = function($word, $duration) {
                        if ($word.parents('.ma-el-animated-headline').hasClass('type')) {
                            ...
                            $word.parents('.ma-el-words-wrapper').animate({
                                ...
                                setTimeout(function() {
                                    Master_Addons.MA_Animated_Headlines.hideWord($word)
                    ...
                    Master_Addons.MA_Animated_Headlines.hideLetter = function($letter, $word, $bool, $duration) {
                        ...
                        if (!$letter.is(':last-child')) {
                            setTimeout(function() {
                                Master_Addons.MA_Animated_Headlines.hideLetter($letter.next(), $word, $bool, $duration);
                            }, $duration);
                        } else if ($bool) {
                            setTimeout(function() {
                                Master_Addons.MA_Animated_Headlines.hideWord(Master_Addons.MA_Animated_Headlines.takeNext($word))
                            }, animationDelay);
                        }
                    ...
                    Master_Addons.MA_Animated_Headlines.showLetter = function($letter, $word, $bool, $duration) {
                        ...
                        if (!$letter.is(':last-child')) {
                            setTimeout(function() {
                                Master_Addons.MA_Animated_Headlines.showLetter($letter.next(), $word, $bool, $duration);
                            }, $duration);
                        } else {
                            if ($word.parents('.ma-el-animated-headline').hasClass('type')) {
                                setTimeout(function() {
                                    $word.parents('.ma-el-words-wrapper').addClass('waiting');
                                }, 200);
                            }
                            if (!$bool) {
                                setTimeout(function() {
        ...
        MA_Image_Filter_Gallery: function($scope, $) {
            ...
            $grid.imagesLoaded().progress(function() {
                $grid.isotope('layout');
                $scope.find('.ma-el-image-filter-gallery').css({
                    "min-height": "300px",
                    "height": container_outerheight
                });
            });
        ...
        MA_BgSlider: function($scope, $) {
            var ma_el_slides = [],
                ma_el_slides_json = [],
                ma_el_transition, ma_el_animation, ma_el_custom_overlay, ma_el_overlay, ma_el_cover, ma_el_delay, ma_el_timer;
